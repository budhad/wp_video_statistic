...
class Admin {
  ...
  private function render_table() {
    ...
    if (count($pages)) {
      ...
      echo "<p>Плагин работает с видео, загруженным на сам сайт средствами wordpress.</p>";
      echo "<p>Умеет показывать кол-во воспроизведений, досматриваний, пауз, воспроизведений после паузы и среднее время просмотра.</p>";
      echo "<p>Данные будут отображены на этой странице таблицей.</p>";
    }
    return ob_get_clean();
  }
